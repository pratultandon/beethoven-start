...
class LSTMNet():
    def __init__(self):
        ...
        # LSTMs
        self.cell = tf.nn.rnn_cell.BasicLSTMCell(n_hidden_recurrent)
        ...
        self.cost, self.final_state = self.inference()
    ...
    def inference(self):
        ...
        print "u0 length: {}".format(self.u0.get_shape())
        print "x length: {}".format(self.x.get_shape())
        ...
        return RBM.get_free_energy_cost(self.x, self.W, self.BV_t, self.BH_t, k=15), self.initial_state
    ...
    def lstm_recurrence(self, u_tm1, sl):
        ...
        print "output of lstm_rec length: {}".format(out.get_shape())
        return u_tm1
    ...
    def generate_recurrence(self, count, k, u_tm1, primer, x, music):
        ...
        u_t  = lstm_recurrence(u_tm1, x_out)
